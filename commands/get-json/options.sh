...
# Created: Mon Aug  3 12:56:08 PDT 2015
#
#/ usage: docker-container-model-source:get-json  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --docker-cert-path <${DOCKER_CERT_PATH:-}> [ --docker-machine-name <>] 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --docker-machine-name) rerun_option_check $# $1; DOCKER_MACHINE_NAME=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
